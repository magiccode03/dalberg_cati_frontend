  ...
  const fetchData = async (page: number = 1, filtersToUse?: typeof filters) => {
    try {
      ...
      if (data.success && data.data && Array.isArray(data.data)) {
        ...
        // Handle Summary Data (Add this section)
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              ...
              {summary && (
                <tr className="bg-gray-100 font-semibold">
                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-mono text-gray-700 text-center">-</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-mono text-gray-700 text-center">{summary.overall_total_qc_assigned.toLocaleString()}</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-mono text-gray-700 text-center">{summary.overall_total_qc_completed.toLocaleString()}</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-mono text-gray-700 text-center">{summary.overall_total_qc_pass.toLocaleString()}</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-mono text-gray-700 text-center">{summary.overall_total_qc_fail.toLocaleString()}</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-mono text-gray-700 text-center">{summary.overall_total_qc_pending.toLocaleString()}</td>
                </tr>
              )}
