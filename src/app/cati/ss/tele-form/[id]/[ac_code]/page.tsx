...
export default function TeleFormV2Page() {
  ...
  const groupFieldsBySection = () => {
    ...
    processedFormConfig.forEach(field => {
      ...
      } else if (['resp_age','resp_registered_voter'].includes(field.tag)) {
      ...
      } else if (['resp_female_edu', 'resp_male_edu', 'resp_occupation', 'resp_name', 'thanks_future', 'resp_gender'].includes(field.tag)) {
