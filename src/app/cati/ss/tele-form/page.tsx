...
export default function TeleFormPage() {
  ...
  const groupQuestionsBySection = () => {
    ...
    processedQuestions.forEach(field => {
      ...
      // Section 3 questions (Impact of loan features) - questions starting with q3_, q4_, q5_, q6_, q7_, q8_
      ...
      // Section 9 questions (Perception of Online/app Lenders) - questions starting with q9_
      else if (field.tag.startsWith('q9_')) {
        sections.section9.push(field);
      }
      // Other questions
      else {
        ...
        {(() => {
          ...
          return (
            <>
                  ...
                  <Card className="p-6 mb-6">
                    ...
                    {questionSections.section2.map((field, index) => {
                      ...
                      if (field.tag === 'q2_13a_i' && isFieldVisible(field)) {
                        const infoSections = sections.find(s => s.id === 'info_sections');
                        const infoSection = infoSections ? (infoSections as any).info_8 : null;
                        return (
                      ...
                      if (field.tag === 'q2_13b_i' && isFieldVisible(field)) {
                        const infoSections = sections.find(s => s.id === 'info_sections');
                        const infoSection = infoSections ? (infoSections as any).info_9 : null;
                        return (
                      ...
                      if (field.tag === 'q2_13c_i' && isFieldVisible(field)) {
                        const infoSections = sections.find(s => s.id === 'info_sections');
                        const infoSection = infoSections ? (infoSections as any).info_10 : null;
                        return (
                      ...
                      if (field.tag === 'q2_13d_i' && isFieldVisible(field)) {
                        const infoSections = sections.find(s => s.id === 'info_sections');
                        const infoSection = infoSections ? (infoSections as any).info_11 : null;
                        return (
                      ...
                      if (field.tag === 'q2_13e_i' && isFieldVisible(field)) {
                        const infoSections = sections.find(s => s.id === 'info_sections');
                        const infoSection = infoSections ? (infoSections as any).info_12 : null;
                        return (
                      ...
                      if (field.tag === 'q2_13f_i' && isFieldVisible(field)) {
                        const infoSections = sections.find(s => s.id === 'info_sections');
                        const infoSection = infoSections ? (infoSections as any).info_13 : null;
                        return (
                  ...
                  <Card className="p-6 mb-6">
                    ...
                    {questionSections.section3.map((field, index) => {
                      ...
                      if (field.tag === 'q3_01' && isFieldVisible(field)) {
                        const infoSections = sections.find(s => s.id === 'info_sections');
                        const infoSection = infoSections ? (infoSections as any).info_2 : null;
                        return (
                      ...
                      if (field.tag === 'q4_01a_i' && isFieldVisible(field)) {
                        const infoSections = sections.find(s => s.id === 'info_sections');
                        const infoSection = infoSections ? (infoSections as any).info_3 : null;
                      ...
                      if (field.tag === 'q4_01d_01' && isFieldVisible(field)) {
                        const infoSections = sections.find(s => s.id === 'info_sections');
                        const infoSection = infoSections ? (infoSections as any).info_1 : null;
                        return (
                      ...
                      if (field.tag === 'q5_01' && isFieldVisible(field)) {
                        const infoSections = sections.find(s => s.id === 'info_sections');
                        const infoSection = infoSections ? (infoSections as any).info_4 : null;
                        return (
                      ...
                      if (field.tag === 'q6_01' && isFieldVisible(field)) {
                        const infoSections = sections.find(s => s.id === 'info_sections');
                        const infoSection = infoSections ? (infoSections as any).info_5 : null;
                        return (
                      ...
                      if (field.tag === 'q7_01' && isFieldVisible(field)) {
                        const infoSections = sections.find(s => s.id === 'info_sections');
                        const infoSection = infoSections ? (infoSections as any).info_6 : null;
                        return (
                      ...
                      if (field.tag === 'q8_01' && isFieldVisible(field)) {
                        const infoSections = sections.find(s => s.id === 'info_sections');
                        const infoSection = infoSections ? (infoSections as any).info_7 : null;
                        const questionHeadingSection = sections.find(s => s.id === 'question_heading');
                        return (
              ...
              {/* Section 9: Perception of Online/app Lenders */}
              {(() => {
                const section9Config = sections.find(s => s.id === 'section_9');
                const showSection9 = formData.consent === '1';
                if (!showSection9) return null;
                
                // Filter visible questions for this section
                const visibleQuestions = questionSections.section9.filter(field => isFieldVisible(field));
                ...
                return (
                  <Card className="p-6 mb-6">
                    {section9Config && (
                      <>
                        <Heading level={4} className="text-gray-900 dark:text-white mb-2">
                          {section9Config.title}
                        </Heading>
                        {section9Config.sub_title && (
                          <Text className="text-gray-600 dark:text-gray-400 mb-6">
                            {section9Config.sub_title}
                          </Text>
                        )}
                    ...
                    {questionSections.section9.map((field, index) => renderField(field, index))}
                  </Card>
                );
              })()}
