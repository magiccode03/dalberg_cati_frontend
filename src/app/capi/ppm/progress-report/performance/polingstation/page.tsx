...
export default function PerformancePolingstationPage() {
  ...
  const handleSearch = () => {
    if (!searchForm.acCode) {
      alert('Please enter AC Code for polingstation level');
      return;
    }
          ...
          <div className="page-title-box">
            <div className="page-title-right">
              <ol className="breadcrumb m-0">
                ...
                <li className="breadcrumb-item active">Performance - Polingstation Level</li>
              </ol>
            </div>
            ...
            <div className="card-body">
              ...
              <div className="d-flex justify-content-between align-items-center mb-3">
                <Heading level={2} className="mb-0">
                  PROGRESS REPORT-POLINGSTATION LEVEL
                </Heading>
                ...
                <Table className="table table-centered table-striped dt-responsive nowrap w-100 border border-gray-300">
                  <thead className="table-light">
                    <tr>
                      ...
                      <th className="border border-gray-300 w-20">PS Code</th>
                      <th className="border border-gray-300 w-32">PS Name</th>
