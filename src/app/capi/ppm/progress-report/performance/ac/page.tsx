...
export default function PerformanceACPage() {
          ...
          <div className="page-title-box">
            <div className="page-title-right">
              <ol className="breadcrumb m-0">
                ...
                <li className="breadcrumb-item active">Performance - AC Level</li>
              </ol>
            </div>
              ...
              <div className="row mb-3">
                <div className="col-md-3">
                  ...
                  <SelectDropdown
                    ...
                    onChange={(value: string | string[]) => handleInputChange('reportDays', Array.isArray(value) ? value[0] : value)}
                    options={[
                      { value: 'all', label: 'All' },
                  ...
                  <>
                    <div className="col-md-3">
                      ...
                      <Input
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleInputChange('customDate', e.target.value)}
                        required
                      />
                    </div>
                    <div className="col-md-3">
                      ...
                      <Input
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleInputChange('customDateEnd', e.target.value)}
                        required
                      />
                    </div>
                  </>
