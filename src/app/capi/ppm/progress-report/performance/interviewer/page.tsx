...
export default function PerformanceInterviewerPage() {
  ...
  const handleSearch = () => {
    if (!searchForm.acCode) {
      alert('Please enter AC Code for interviewer level');
      return;
    }
          ...
          <div className="page-title-box">
            <div className="page-title-right">
              <ol className="breadcrumb m-0">
                ...
                <li className="breadcrumb-item active">Performance - Interviewer Level</li>
              </ol>
            </div>
          ...
          <div className="card">
            <div className="card-body">
              <div className="row mb-3">
                ...
                <div className="col-md-2">
                  <label className="form-label">AC Code <span className="text-red-500">*</span></label>
                  <Input
                    type="text"
              ...
              <div className="d-flex justify-content-between align-items-center mb-3">
                <Heading level={2} className="mb-0">
                  PROGRESS REPORT-INTERVIEWER LEVEL
                </Heading>
                ...
                <Table className="table table-centered table-striped dt-responsive nowrap w-100 border border-gray-300">
                  <thead className="table-light">
                    <tr>
                      ...
                      <th className="border border-gray-300 w-20">Interviewer Code</th>
                      <th className="border border-gray-300 w-32">Interviewer Name</th>
