...
import { apiService, PCLevelReportData, PerformanceReportParams } from '@/lib/api';

export default function QualityPCPage() {
  ...
  const [progressData, setProgressData] = useState<PCLevelReportData[]>([]);
          ...
          <div className="page-title-box">
            <div className="page-title-right">
              <ol className="breadcrumb m-0">
                ...
                <li className="breadcrumb-item active">Quality - PC Level</li>
              </ol>
            </div>
                    ...
                    {loading ? (
                      ...
                      currentData.map((item, index) => (
                        <tr key={item.pc_code}>
                          ...
                          <td className="border border-gray-300">{item.pc_code}</td>
