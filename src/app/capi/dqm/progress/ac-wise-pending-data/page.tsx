                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {currentData.map((acData) => (
                      <tr key={acData.id} className="hover:bg-gray-50">
                        <td className="px-4 py-4 text-center whitespace-nowrap text-sm font-mono text-gray-900">{acData.srNo}</td>
                        <td className="px-4 py-4 text-center whitespace-nowrap text-sm font-mono text-gray-900">{acData.acCode}</td>
                        <td className="px-4 py-4 text-left whitespace-nowrap text-sm text-gray-900">{acData.acName}</td>
                        <td className="px-4 py-4 text-center whitespace-nowrap text-sm font-mono text-gray-900">{acData.pendingInterview}</td>
                      </tr>
                    ))}
                  </tbody>
                </Table>
