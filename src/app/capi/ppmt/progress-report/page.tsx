  ...
  const getTableHeaders = () => {
    ...
    if (type === 'performance') {
      switch (level) {
        case 'ac':
          return [
            { key: 'sr', label: 'Sr.No.', width: 'w-16', className: 'text-center' },
            { key: 'ac_code', label: 'AC Code', width: 'w-20', className: 'text-center' },
            { key: 'ac_name', label: 'AC Name', width: 'w-32', className: 'text-left' },
            { key: 'pc_name', label: 'Pc Name', width: 'w-32', className: 'text-left' },
            { key: 'target_sample', label: 'Target Sample', width: 'w-24', className: 'text-center' },
            { key: 'interviewer', label: 'No of Interviewers Worked', width: 'w-32', className: 'text-center' },
            { key: 'ps_covered', label: 'PS Covered', width: 'w-24', className: 'text-center' },
            { key: 'completed_interviews', label: 'Completed Interviews', width: 'w-32', className: 'text-center' },
            { key: 'terminated_interviews', label: 'Terminated Interviews', width: 'w-32', className: 'text-center' },
            { key: 'system_rejections', label: 'System rejections', width: 'w-32', className: 'text-center' },
            { key: 'counts_after_terminated', label: 'Counts after Terminated and System Rejection', width: 'w-40', className: 'text-center' },
            { key: 'gps_pending', label: 'GPS Pending', width: 'w-24', className: 'text-center' },
            { key: 'gps_fail', label: 'GPS Fail', width: 'w-20', className: 'text-center' },
            { key: 'passed', label: 'Passed', width: 'w-20', className: 'bg-green-500 text-white text-center' },
            { key: 'failed', label: 'Failed', width: 'w-20', className: 'bg-red-500 text-white text-center' },
            { key: 'under_qc', label: 'Under QC', width: 'w-24', className: 'bg-blue-500 text-white text-center' },
            { key: 'female_per', label: '% Of Female Interviews', width: 'w-32', className: 'text-center' },
            { key: 'without_phone_per', label: '% of interviews without Phone Number', width: 'w-40', className: 'text-center' },
            { key: 'actual_sc', label: 'Actual % of SC', width: 'w-24', className: 'text-center' },
            { key: 'mentioned_sc', label: '% of Interviews mentioned as SC', width: 'w-36', className: 'text-center' },
            { key: 'actual_muslim', label: 'Actual % of Muslims', width: 'w-28', className: 'text-center' },
            { key: 'mentioned_muslim', label: '% of Interviews mentioned as Muslims', width: 'w-40', className: 'text-center' },
            { key: 'age_18_24', label: '% of Interviews under the age of (18-24)', width: 'w-40', className: 'text-center' },
            { key: 'age_50_plus', label: '% of Interviews under the age of (50+)', width: 'w-40', className: 'text-center' }
          ];
        case 'pc':
          return [
            { key: 'sr', label: 'Sr.No.', width: 'w-16', className: 'text-center' },
            { key: 'pc_code', label: 'PC Code', width: 'w-20', className: 'text-center' },
            { key: 'pc_name', label: 'PC Name', width: 'w-32', className: 'text-left' },
            { key: 'target_sample', label: 'Target Sample', width: 'w-24', className: 'text-center' },
            { key: 'interviewer', label: 'No of Interviewers Worked', width: 'w-32', className: 'text-center' },
            { key: 'ps_covered', label: 'PS Covered', width: 'w-24', className: 'text-center' },
        ...
        case 'interviewer':
          return [
            { key: 'sr', label: 'Sr.No.', width: 'w-16', className: 'text-center' },
            { key: 'interviewer_id', label: 'Interviewer ID', width: 'w-32', className: 'text-center' },
            { key: 'no_of_ac', label: 'No of AC covered', width: 'w-32', className: 'text-center' },
            { key: 'pscovered', label: 'PS Covered', width: 'w-24', className: 'text-center' },
            { key: 'total_interview', label: 'Completed Interviews', width: 'w-32', className: 'text-center' },
            { key: 'invalid', label: 'Terminated Interviews', width: 'w-32', className: 'text-center' },
            { key: 'reject_auto', label: 'System rejections', width: 'w-32', className: 'text-center' },
            { key: 'count_after_termination_and_rejection', label: 'Counts after Terminated and System Rejection', width: 'w-40', className: 'text-center' },
            { key: 'valid', label: 'Passed', width: 'w-20', className: 'bg-green-500 text-white text-center' },
            { key: 'reject', label: 'Failed', width: 'w-20', className: 'bg-red-500 text-white text-center' },
            { key: 'interview_in_qc_total', label: 'Under QC', width: 'w-24', className: 'bg-blue-500 text-white text-center' },
            { key: 'female_per', label: '% Of Female Interviews', width: 'w-32', className: 'text-center' },
            { key: 'no_of_day', label: 'No of days worked', width: 'w-32', className: 'text-center' },
            { key: 'without_audio', label: 'No of Interviews without audio', width: 'w-40', className: 'text-center' },
            { key: 'average_per_day', label: 'Average per day', width: 'w-32', className: 'text-center' },
            { key: 'min_achivement', label: 'Lowest achievement', width: 'w-32', className: 'text-center' },
            { key: 'max_achivement', label: 'Highest achievement', width: 'w-32', className: 'text-center' },
            { key: 'without_phone_per', label: '% of interviews without Phone Number', width: 'w-40', className: 'text-center' },
            { key: 'sc_category_per', label: '% of Interviews mentioned as SC', width: 'w-36', className: 'text-center' },
            { key: 'muslim_category_per', label: '% of Interviews mentioned as Muslims', width: 'w-40', className: 'text-center' },
            { key: 'age_18_24_per', label: '% of Interviews under the age of (18-24)', width: 'w-40', className: 'text-center' },
            { key: 'age_50_above_per', label: '% of Interviews under the age of (50+)', width: 'w-40', className: 'text-center' },
            { key: 'rejection_per', label: '% of Rejection', width: 'w-32', className: 'text-center' }
          ];
        case 'polingstation':
          return [
            { key: 'sr', label: 'Sr.No.', width: 'w-16', className: 'text-center' },
            { key: 'polling_station_name', label: 'Polling Station Name', width: 'w-40', className: 'text-left' },
            { key: 'ac_name', label: 'AC Name', width: 'w-32', className: 'text-left' },
            { key: 'target_sample', label: 'Target Sample', width: 'w-24', className: 'text-center' },
            { key: 'interviewer', label: 'No of Interviewers Worked', width: 'w-32', className: 'text-center' },
            { key: 'total_interview', label: 'Completed Interviews', width: 'w-32', className: 'text-center' },
      ...
      switch (level) {
        case 'ac':
          return [
            ...
            { key: 'interviewer', label: 'No of Interviewers Worked', width: 'w-32', className: 'text-center' },
            { key: 'total_interview', label: 'Completed Interviews', width: 'w-32', className: 'text-center' },
            { key: 'valid', label: 'Pass interviews', width: 'w-32', className: 'text-center' },
            { key: 'valid_without_phone_per', label: '% of pass interviews without Phone Number', width: 'w-40', className: 'text-center' },
            { key: 'assign_to_audioqc', label: 'Assigned to Audio', width: 'w-32', className: 'text-center' },
            { key: 'interview_in_qc_total', label: 'Under QC Interviews', width: 'w-32', className: 'text-center' },
            { key: 'reject', label: 'Fail Interviews', width: 'w-32', className: 'text-center' },
            { key: 'reject_auto', label: 'System Fail', width: 'w-24', className: 'text-center' },
            { key: 'reject_short', label: 'Short Interviews Fail', width: 'w-32', className: 'text-center' },
            { key: 'reject_duplicatephone', label: 'Duplicate Mobile Number', width: 'w-32', className: 'text-center' },
            { key: 'reject_qc_audio', label: 'Audio Fail', width: 'w-24', className: 'text-center' },
            { key: 'reject_qc_audio_gender', label: 'Survey conversation can be heard', width: 'w-40', className: 'text-center' },
            { key: 'reject_qc_audio_blank', label: 'No Conversation', width: 'w-32', className: 'text-center' },
            { key: 'reject_qc_audio_irrelevant', label: 'Irrelevant conversation', width: 'w-40', className: 'text-center' },
            { key: 'reject_qc_audio_respondent', label: 'Interviewer acting as respondent', width: 'w-48', className: 'text-center' },
            { key: 'reject_qc_audio_interviewer_more', label: 'Can hear the interviewer more than the respondent', width: 'w-56', className: 'text-center' },
            { key: 'reject_qc_audio_mechanical', label: 'The interviewer is asking questions mechanically', width: 'w-56', className: 'text-center' },
            { key: 'reject_rta', label: 'N+W+RTA Fail', width: 'w-24', className: 'text-center' }
          ];
        case 'pc':
          return [
            { key: 'sr', label: 'Sr.No.', width: 'w-16', className: 'text-center' },
            ...
            { key: 'total_interview', label: 'Completed Interviews', width: 'w-32', className: 'text-center' },
            { key: 'valid', label: 'Pass interviews', width: 'w-32', className: 'text-center' },
            { key: 'valid_without_phone_per', label: '% of Valid interviews without Phone Number', width: 'w-40', className: 'text-center' },
            { key: 'assign_to_qc', label: 'Assigned to Audio', width: 'w-32', className: 'text-center' },
            { key: 'interview_in_qc_total', label: 'Under QC Interviews', width: 'w-32', className: 'text-center' },
            { key: 'reject', label: 'Fail Interviews', width: 'w-32', className: 'text-center' },
            { key: 'reject_auto', label: 'System Fail', width: 'w-24', className: 'text-center' },
            { key: 'reject_short', label: 'Short Interviews Fail', width: 'w-32', className: 'text-center' },
        ...
        case 'interviewer':
          return [
            ...
            { key: 'reject_qc_audio_mechanical', label: 'The interviewer is asking questions mechanically', width: 'w-56', className: 'text-center' },
            { key: 'reject_rta', label: 'N+W+RTA Fail', width: 'w-24', className: 'text-center' },
            { key: 'rejection_per', label: 'Rejection %', width: 'w-24', className: 'text-center' }
          ];
        case 'polingstation':
          return [
            { key: 'sr', label: 'Sr.No.', width: 'w-16', className: 'text-center' },
            ...
            { key: 'valid_without_phone_per', label: '% of Pass interviews without Phone Number', width: 'w-40', className: 'text-center' },
            { key: 'assign_to_audioqc', label: 'Assigned to Audio', width: 'w-32', className: 'text-center' },
            { key: 'interview_in_qc_total', label: 'Under QC Interview', width: 'w-32', className: 'text-center' },
            { key: 'reject', label: 'Fail Interviews', width: 'w-32', className: 'text-center' },
            { key: 'reject_auto', label: 'System Fail', width: 'w-24', className: 'text-center' },
            { key: 'reject_short', label: 'Short Interviews', width: 'w-32', className: 'text-center' },
            { key: 'reject_duplicatephone', label: 'Duplicate Mobile Number', width: 'w-32', className: 'text-center' },
            { key: 'reject_qc_audio', label: 'Audio Fail', width: 'w-24', className: 'text-center' },
            { key: 'reject_rta', label: 'N+W+RTA Fail', width: 'w-24', className: 'text-center' }
          ];
