...
export default function PPMTRejectionReportPage() {
  ...
  const rejectionData: RejectionData[] = [
    ...
    },
    {
      ...
      interviewDate: '2025-06-15',
      interviewerId: '721',
      interviewDuration: '00:07:15',
      respondentName: 'Suresh Kumar',
      respondentMobile: '9876543210',
      failReason: 'Rejected (Audio reject)',
      audioQcId: 'QC001',
      audioFailReason: 'Poor audio quality',
      reAudioFailReason: 'Background noise',
      hasAudio: true,
      hasGps: true
    },
    {
    ...
    },
    {
      ...
      interviewDate: '2025-06-15',
      interviewerId: '721',
      interviewDuration: '00:09:12',
      respondentName: 'Rajesh Kumar',
      respondentMobile: '9876543211',
      failReason: 'Rejected (N+W+RTA)',
      audioQcId: '',
      audioFailReason: '',
      reAudioFailReason: '',
