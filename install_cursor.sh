...
TEMP_EXTRACT_DIR="$HOME/.local/share/cursor-agent/versions/.tmp-2025.10.02-bd871ac-$(date +%s)"
...
DOWNLOAD_URL="https://downloads.cursor.com/lab/2025.10.02-bd871ac/${OS}/${ARCH}/agent-cli-package.tar.gz"
...
FINAL_DIR="$HOME/.local/share/cursor-agent/versions/2025.10.02-bd871ac"
rm -rf "${FINAL_DIR}"
...
ln -s ~/.local/share/cursor-agent/versions/2025.10.02-bd871ac/cursor-agent ~/.local/bin/cursor-agent
